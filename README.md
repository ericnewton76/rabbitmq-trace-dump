...
- 📄 **Parse RabbitMQ trace logs** - Read JSON-formatted trace files generated by RabbitMQ's tracing plugin
- 🔍 **BSON payload decoding** - Automatically decode Base64-encoded BSON payloads into readable JSON
- 🎨 **Syntax-highlighted output** - Color-coded JSON output using Spectre.Console
- 🧭 **Interactive mode** - Navigate through records with keyboard controls
- 🔎 **Filtering/Search** - Filter records by property values
- 👁️ **Hide properties** - Exclude specific properties from output
...
| Key | Action |
|-----|--------|
| <kbd>↓</kbd> / <kbd>Space</kbd> | Next record |
